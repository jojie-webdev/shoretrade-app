...
import { AccountCompletionGeneratedProps } from 'routes/Buyer/Account/AccountCompletion/AccountCompletion.props';
import {
  Container,
  InfoContainer,
} from 'routes/Buyer/Account/AccountCompletion/AccountCompletion.style';
