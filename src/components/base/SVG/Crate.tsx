  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={fill || '#565A6A'}
      />
      <path d="M12 8V21" stroke={fill || '#565A6A'} strokeWidth="2" />
      <path d="M22 6L12 21" stroke={fill || '#565A6A'} strokeWidth="2" />
      <path d="M12 8L22 18" stroke={fill || '#565A6A'} strokeWidth="2" />
    </svg>
  );
};
