...
import { SwiperContainerV2Props } from './SwiperContainerV2.props';
import { Parent, Container } from './SwiperContainerV2.style';
 ...
 *
 */
const SwiperContainerV2 = (props: SwiperContainerV2Props): JSX.Element => {
  const { children, height, aspectRatio = '9:4', addMargin, onResize } = props;
...
export default React.memo(SwiperContainerV2);
