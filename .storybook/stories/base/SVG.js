  ...
  return (
    <Container background="white">
      <Content>
        ...
        {/* <Wrapper label="TechByShoretradeSellerLogo">
          <TechByShoretradeSellerLogo width={30} height={30} />
        </Wrapper>
        <Wrapper label="TechByShoretradeLogo">
          <TechByShoretradeLogo width={30} height={30} />
        </Wrapper> */}
        <Wrapper label="SfmBuyerListing">
          <SfmBuyerListing width={30} height={30} />
        </Wrapper>
        <Wrapper label="SfmBuyerNegotiatePrice">
          <SfmBuyerNegotiatePrice width={30} height={30} />
        </Wrapper>
        ...
        <Wrapper label="AngleDown">
          <AngleDown width={30} height={30} />
        </Wrapper>
        <Wrapper label="ShoppingTrolley">
          <ShoppingTrolley width={30} height={30} />
        </Wrapper>
        <Wrapper label="MapMarker">
          <MapMarker width={30} height={30} />
        </Wrapper>
        <Wrapper label="Bill">
          <Bill width={30} height={30} />
        </Wrapper>
        <Wrapper label="Crates2">
          <Crates2 width={30} height={30} />
        </Wrapper>
        <Wrapper label="QrCodeScan">
          <QrCodeScan width={30} height={30} />
        </Wrapper>
        <Wrapper label="Home3">
